...
const AddNoteCategory = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.BACKEND_API}/categories/notes`, { name, criteria });
  ...
  return (
    <form onSubmit={handleSubmit} className="category-form">
      ...
      <input type="text" value={criteria} onChange={(e) => setCriteria(e.target.value)} placeholder="Criteria" required />
